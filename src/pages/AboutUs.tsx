      ...
      <section className="bg-emerald/10 py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-center text-dark/70 max-w-3xl mx-auto font-opensans">
            Votre partenaire de confiance pour découvrir les merveilles de Madagascar depuis plus de 10 ans.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 mb-8">
            ...
            <h2 className="text-3xl font-poppins font-bold text-dark">Notre Mission</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-dark/70 mb-4 font-opensans">
                Notre mission est de faire découvrir la beauté unique de Madagascar tout en préservant son environnement 
                et en soutenant les communautés locales. Nous nous engageons à:
              </p>
              <ul className="space-y-4 text-dark/70 font-opensans">
                <li className="flex items-start gap-2">
                  <Award className="w-5 h-5 text-emerald mt-1" />
                  <span>Offrir des expériences de voyage authentiques et responsables</span>
                </li>
                <li className="flex items-start gap-2">
                  <Award className="w-5 h-5 text-emerald mt-1" />
                  <span>Contribuer au développement durable des communautés locales</span>
                </li>
                <li className="flex items-start gap-2">
                  <Award className="w-5 h-5 text-emerald mt-1" />
                  <span>Protéger et préserver la biodiversité unique de Madagascar</span>
                </li>
              </ul>
            </div>
            <div className="relative h-[400px]">
              <img 
                src="/lovable-uploads/e33ed146-65bb-44b8-9251-84d03d375284.png" 
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 mb-8">
            ...
            <h2 className="text-3xl font-poppins font-bold text-dark">Notre Équipe</h2>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-2 mb-8">
            ...
            <h2 className="text-3xl font-poppins font-bold text-dark">Notre Histoire</h2>
          </div>
          <div className="max-w-3xl mx-auto space-y-8">
            <div className="border-l-4 border-emerald pl-6">
              <h3 className="text-xl font-poppins font-semibold mb-2">2013 - Les débuts</h3>
              <p className="text-dark/70 font-opensans">
                Création de Madagascar Travel avec une vision claire : faire découvrir l'authenticité de Madagascar.
              </p>
            </div>
            <div className="border-l-4 border-emerald pl-6">
              <h3 className="text-xl font-poppins font-semibold mb-2">2016 - Expansion</h3>
              <p className="text-dark/70 font-opensans">
                Développement de nouveaux circuits et partenariats avec les communautés locales.
              </p>
            </div>
            <div className="border-l-4 border-emerald pl-6">
              <h3 className="text-xl font-poppins font-semibold mb-2">2019 - Reconnaissance</h3>
              <p className="text-dark/70 font-opensans">
                Obtention de plusieurs prix pour notre engagement dans le tourisme durable.
              </p>
            </div>
            <div className="border-l-4 border-emerald pl-6">
              <h3 className="text-xl font-poppins font-semibold mb-2">2023 - Aujourd'hui</h3>
              <p className="text-dark/70 font-opensans">
